...
return Def.ActorFrame{
	...
	Def.Quad{
		...
		InitCommand=function(self)
			...
			self:diffuse( SL_Config:get_data().RainbowMode and Color.White or Color.Black ):diffusealpha(0)
		end,
	...
	Def.Quad{
		...
		InitCommand=function(self)
			self:horizalign(center):vertalign(middle)
				:diffuse( SL_Config:get_data().RainbowMode and Color.Black or Color.White )
	...
	Def.BitmapText{
		...
		InitCommand=function(self)
			self:diffuse( SL_Config:get_data().RainbowMode and Color.White or Color.Black ):zoom(0.6)
		end
	}
}
